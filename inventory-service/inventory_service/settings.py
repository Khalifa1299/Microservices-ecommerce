...
Owns: inventory, analytics, pos apps
Port: 8005
"""
...
LOGGING = {
    ...
    'formatters': {
        'verbose': {'format': '%(asctime)s [inventory-service] %(levelname)s %(message)s'},
    },
    'handlers': {
...
_provider = TracerProvider(resource=Resource.create({SERVICE_NAME: "inventory-service"}))
